...
Tabs.Settings:AddParagraph({
    Title = "Custom UI",
    Content = "Native Linko UI loaded. Use the top bar to minimize or close."
})

Window:SelectTab(1)

print("[linkoro57] Infinite Money with custom UI loaded successfully!")
